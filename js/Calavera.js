...
export default function E08({x,y,z}){
    var material = new THREE.MeshToonMaterial({color: 0xdbcab8});
  ...
  brazo.position.set(-5.7,-4.7,0);
  brazo.rotation.z= -0.5;
  ...
  brazo3.position.set(-7,-4.8,2);
  brazo3.rotation.x= 7;
  var brazo4 = new THREE.Mesh(brazog,material);
  //scene.add(brazo4);
  brazo4.castShadow=true;
  brazo4.position.set(8.3,-5.2,1.5);
  brazo4.rotation.set(7,0,-.5);
...
// Palma
 const trapecioShape = new THREE.Shape();
  ...
  mano.position.set(10,-2.9, 3);
  mano.rotation.set(0.2,-0.6,-0.5)

  var mano2 = mano.clone();
  mano2.position.set(-7.2,-2 ,4.5);
  mano2.rotation.set(0.2,3,-0.3)
  //scene.add(mano2);
        
        
            var ESC08= new THREE.Group();
            ESC08.add(craneo,garganta,columna,columna1,costillas,costillas2,brazos,mano,mano2);
